...
def processData():
    ...
    hepdata_tables="rawdata/"+tables[0]+".yaml"
    ...
    for i in range(len(values)):
        ...
        m_ttBar_central = None
        kin_value = {'sqrt_s': {'min': None, 'mid': sqrt_s, 'max': None}, 'm_ttBar': {'min': m_ttBar_min, 'mid': m_ttBar_central, 'max': m_ttBar_max}}
